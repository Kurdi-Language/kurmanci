...
| **Human-Reviewed Dataset (4B.3)** | Active | Initial authoritative human-reviewed Kurmancî evaluation cases, added only after explicit review by real Kurmancî speakers. |
