...
| **Benchmark Review Governance (4B.3A)** | Active | Reviewer/date validation, metadata-only promotion semantics, filesystem snapshot transition validation, evidence standards, governance, tests, and PR-scoped benchmark-data protection. Adds no benchmark cases. |
| **Initial Human-Reviewed Dataset (4B.3B)** | Planned | Separate human data-review milestone for a small, high-confidence authoritative Kurmancî benchmark. |
