...
| **Corpus Infrastructure & Partitioning (3C1)** | Active | Format-sensitive registry validation, canonical JSONL document ingestion, atomic sibling-staging import transactions, inventory/audit reports, and leakage-free train/dev/eval partitioning. |
