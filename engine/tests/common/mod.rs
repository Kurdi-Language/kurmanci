//! Deterministic pack-schema-4 builders shared by the compatibility and corruption tests.
//! They mirror the data-builder's encoder byte for byte for the subset they cover, so a pack
//! they produce is a genuine v4 pack, not a mock.
