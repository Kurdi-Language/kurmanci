...
pub const EXPECTED_DECISIONS_SHA256: &str =
    "986af1bd0505640eee61627476ce67529077d8e18d19eae9324689699f3c4cb2";
pub const EXPECTED_REVIEWER_ID: &str = "ferhatguneri";
pub const EXPECTED_AUDIT_CONFIRMATION_DATE: &str = "2026-09-17";

pub const EXPECTED_APPROVED_COUNT: usize = 721;
pub const EXPECTED_APPROVED_WITH_METADATA_CHANGE_COUNT: usize = 0;
pub const EXPECTED_REJECTED_FROM_DEFAULT_PACK_COUNT: usize = 226;
...
pub const EXPECTED_KUWIKI_BATCH_002_CANDIDATES_SHA256: &str =
    "169f200a6f157cc565f7da283e9c07a5a168f8c902f9f66ed713a629472e9178";
...
pub const EXPECTED_KUWIKI_BATCH_002_DECISIONS_SHA256: &str =
    "0d36f821dceb94de675e2f77dffca3ae6f513d14fb7bc97dc856b2fc889448f8";
pub const EXPECTED_KUWIKI_BATCH_002_REVIEWER_ID: &str = "ferhatguneri";
pub const EXPECTED_KUWIKI_BATCH_002_AUDIT_CONFIRMATION_DATE: &str = "2026-09-17";

pub const EXPECTED_KUWIKI_BATCH_002_APPROVED_COUNT: usize = 590;
pub const EXPECTED_KUWIKI_BATCH_002_APPROVED_WITH_METADATA_CHANGE_COUNT: usize = 0;
pub const EXPECTED_KUWIKI_BATCH_002_REJECTED_FROM_DEFAULT_PACK_COUNT: usize = 299;
