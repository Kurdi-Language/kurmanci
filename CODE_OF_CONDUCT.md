...
reported to the project maintainers via private communication or GitHub Organization contact:

- **Private Conduct Contact**: `conduct@kurmanci.org` (or via maintainer direct private messaging on GitHub).
